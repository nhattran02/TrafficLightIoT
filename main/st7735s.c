...
/**
* @brief Initializes SPI master mode with the specified GPIO pins and device handle.
* This function initializes SPI master mode using the given GPIO pins for MOSI, SCLK, CS, DC, and RESET signals.
* It also configures the SPI bus and device interface using the given device handle.
* @param dev Pointer to the ST7735_t struct that holds information about the device.
* @param GPIO_MOSI GPIO pin for MOSI signal.
* @param GPIO_SCLK GPIO pin for SCLK signal.
* @param GPIO_CS GPIO pin for CS signal.
* @param GPIO_DC GPIO pin for DC signal.
* @param GPIO_RESET GPIO pin for RESET signal.
*/
...
/**
 * @brief This function writes a byte to the SPI bus
 * 
 * @param SPIHandle The handle of the SPI device to write to.
...
/**
 * @brief This function writes a command to the ST7735 display
 * 
 * @param dev pointer to the ST7735_t struct
...
/**
 * @brief This function writes a single byte of data to the display
 * 
 * @param dev pointer to the ST7735_t struct
...
/**
 * @brief This function writes a 16-bit word to the display
 * 
 * @param dev pointer to the ST7735_t structure
 * @param data the 16-bit data to be sent
...
/**
 * @brief This function writes the address of the first pixel to be written to the display
 * 
 * @param dev pointer to the ST7735_t structure
 * @param addr1 The first address to write to.
 * @param addr2 The last address of the data to be written.
 */
...
/**
 * @brief This function writes a color to the display
 * 
 * @param dev pointer to the ST7735_t structure
...
/**
 * @brief It takes an array of 16-bit colors and converts them to an array of 8-bit colors and then sends
 * them to the display
 * 
 * @param dev The ST7735_t structure that was created in the previous step.
 * @param colors pointer to an array of 16-bit colors
 * @param size the number of pixels to write
 * 
 * @return A boolean value.
 */
...
/**
 * @brief The function initializes the ST7735 LCD controller by sending a series of commands and data to the
 * controller
 * 
 * @param dev pointer to the ST7735_t struct
 * @param width the width of the display in pixels
 * @param height the height of the display in pixels
 * @param offsetx The x offset of the display. This is the number of pixels from the left of the
 * display to the left of the visible area.
 * @param offsety The y offset of the display. This is the number of pixels from the top of the display
 * to the top of the actual display area.
 */
...
/**
 * @brief Set the column and row address, then write the pixel color to the display
 * 
 * @param dev the ST7735_t struct that was returned by the init function
...
/**
 * @brief Draws a horizontal line of pixels of the same color
 * 
 * @param dev the ST7735_t struct that was returned by the lcdInit() function
 * @param x The x coordinate of the first pixel to be drawn.
 * @param y The y coordinate of the top left corner of the rectangle.
 * @param size the number of pixels to draw
 * @param colors a pointer to an array of colors to be written to the screen
 * 
...
/**
 * @brief Set the column and page addresses, then write the color to the display
 * 
 * @param dev the ST7735_t struct that was returned from the lcdInit() function
 * @param x1 The x coordinate of the upper left corner of the rectangle
 * @param y1 The top of the rectangle
